...
const games = ['spaceInvaders', 'brickBreaker', 'tetris', 'mazeRunner'];
...
fontFileInput.addEventListener('change', async (event) => {
    ...
    if (file) {
        ...
        font.load().then(function(loadedFont) {
            ...
            startGame(selectedGame, 'customFont');  // Pass the selected game and custom font to the startGame function
...
function startGame(game, font) {
    startBrickBreaker(font);
    // switch (game) {
    //     case 'spaceInvaders':
    //         startSpaceInvaders(font);
    //         break;
    //     case 'brickBreaker':
    //         startBrickBreaker(font);
    //         break;
...
//     // Determine canvas size based on the screen size
